...
Feature.inherits(SediaAccoglienzaPari, Feature);

function SediaAccoglienzaPari(feature) {
    Feature.call(this, feature);
}

SediaAccoglienzaPari.prototype.style = {
                            prefix: "fa",
                            icon: "medkit",
                            zIndex: 3
                        };

SediaAccoglienzaPari.prototype.in_graph = true;

SediaAccoglienzaPari.prototype.in_2D_map = false;

SediaAccoglienzaPari.prototype.get3DModel = function() {
      ...
      var sediaAccoglienzaPari = new THREE.Object3D();
      ...
      var reggiSedile2 = creaReggiSedile();
      reggiSedile1.position.set(0.18,-0.25,0);
      reggiSedile2.position.set(-0.18,-0.25,0);
      sedile1.position.x =0.45 +0.45/2;
      sedile2.position.x =-0.45 -0.45/2;
      sedile3.position.x =0.45/2;
      sedile4.position.x =-0.45/2;
      sedile1.add(reggiSedile1);
      sedile2.add(reggiSedile2);
      sediaAccoglienzaPari.add(sedile1);
      sediaAccoglienzaPari.add(sedile2);
      sediaAccoglienzaPari.add(sedile3);
      sediaAccoglienzaPari.add(sedile4);
      ...
      function creaBase () {
        ...
        var geometriaReggiBase1 = new THREE.CylinderGeometry(0.02,0.02,0.05,Math.round(32*detail));
        var geometriaBordoBase = new THREE.CylinderGeometry(0.01,0.01,0.4,Math.round(32*detail));
        var geometriaFineBase = new THREE.CylinderGeometry(0.015,0.015,0.395,Math.round(32*detail));
        var geometriaBordoFineBase = new THREE.SphereGeometry(0.015,Math.round(32*detail),Math.round(32*detail));
        var geometriaBordoBase2 = new THREE.SphereGeometry(0.01,Math.round(32*detail),Math.round(32*detail));
      ...
      function creaSchienale () {
        ...
        var geometriaBordoSchienale1 = new THREE.CylinderGeometry(0.01,0.01,0.44,Math.round(32*detail));
        var geometriaBordoSchienale2 = new THREE.CylinderGeometry(0.01,0.01,0.4,Math.round(32*detail));
        var geometriaFineSchienale = new THREE.CylinderGeometry(0.015,0.015,0.395,Math.round(32*detail));
        var geometriaFineSchienale2 = new THREE.SphereGeometry(0.015,Math.round(32*detail),Math.round(32*detail));
    ...
    sediaAccoglienzaPari.name = this.id;
    sediaAccoglienzaPari.feature = this;
    var model = Feature.packageModel(sediaAccoglienzaPari);
    return model;
};

module.exports = SediaAccoglienzaPari;
