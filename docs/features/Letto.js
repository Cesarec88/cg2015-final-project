...
Letto.prototype.get3DModel = function() {
	 var letto = new THREE.Object3D( );
      ...
      var bedWallTube_geometry = new THREE.CylinderGeometry( 0.3 , 0.3 , 8 , Math.round(32*detail) );
      ...
      var bedWallUpperTube_geometry = new THREE.CylinderGeometry( 0.3 , 0.3 , 14 , Math.round(32*detail) );
      ...
      var bedWallUpperSphere1_geometry = new THREE.SphereGeometry( 0.55 , Math.round(32*detail) ,Math.round(32*detail) );
      ...
      var bedCylinder_geometry = new THREE.CylinderGeometry( 4, 4, 4, Math.round(32*detail) );
      ...
      var wheelCenter_geometry = new THREE.CylinderGeometry( 0.7 , 0.4 , 2 , Math.round(32*detail));
      var wheelCenter1 = new THREE.Mesh( wheelCenter_geometry , bedLowerBase_material );

      var wheelJoint_geometry = new THREE.SphereGeometry( 0.6 , Math.round(32*detail) , Math.round(32*detail) );
